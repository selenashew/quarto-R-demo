...
We can see from @fig_horse_pops_plot that Ontario, Saskatchewan and Alberta 
...
Additionally, note that in @tbl-horses-sd we consider the sample standard deviation of the number of horses during the same time span as @fig_horse_pops_plot.
